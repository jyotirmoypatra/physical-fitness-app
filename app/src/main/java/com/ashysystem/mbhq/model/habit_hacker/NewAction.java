...
public class NewAction implements Serializable {
  ...
  /*  @SerializedName("HasReminder")
    @Expose
    private Object hasReminder;*/
    @SerializedName("Picture")
    @Expose
    private String picture;
  /*  @SerializedName("UploadPictureImgFileName")
    @Expose
    private Object uploadPictureImgFileName;*/
  ...
  /*  @SerializedName("IsCreatedUpdated")
   ...
   /* @SerializedName("LastReminderStatus")
    @Expose
    private Object lastReminderStatus;*/
  ...
  /*  @SerializedName("goal_mindset_reminder_master_Details")
    @Expose
    private List<GoalMindsetReminderMasterDetail> goalMindsetReminderMasterDetails = null;*/
...
*/
  ...
  /*  public Object getHasReminder() {
        return hasReminder;
    }

    public void setHasReminder(Object hasReminder) {
...
*/
  ...
  /*  public Object getUploadPictureImgFileName() {
        return uploadPictureImgFileName;
    }

    public void setUploadPictureImgFileName(Object uploadPictureImgFileName) {
...
*/
   ...
   /* public Object getLastReminderStatus() {
        return lastReminderStatus;
    }

    public void setLastReminderStatus(Object lastReminderStatus) {
   ...
   /* public Object getGoalDetails() {
    ...
    public List<GoalMindsetReminderMasterDetail> getGoalMindsetReminderMasterDetails() {
        return goalMindsetReminderMasterDetails;
    }

    public void setGoalMindsetReminderMasterDetails(List<GoalMindsetReminderMasterDetail> goalMindsetReminderMasterDetails) {
...
*/
    ...
    public NewAction setDuration(Integer duration) {
    ...
    public NewAction setOverallPerformance(Double overallPerformance) {
    ...
    public NewAction setTotalDone(Double totalDone) {
