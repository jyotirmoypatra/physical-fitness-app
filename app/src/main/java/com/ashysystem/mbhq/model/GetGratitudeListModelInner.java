...
/**
 * Created by android-krishnendu on 3/9/17.
 */

public class GetGratitudeListModelInner {
    ...
    public GetGratitudeListModelInner setDateValue(String dateValue) {
    ...
    public String getReminderAt1() {
        return reminderAt1;
    }

    public void setReminderAt1(String reminderAt1) {
        this.reminderAt1 = reminderAt1;
    }

    public String getReminderAt2() {
        return reminderAt2;
    }

    public void setReminderAt2(String reminderAt2) {
    ...
    public GetGratitudeListModelInner setReminderAt1Int(Integer reminderAt1Int) {
    ...
    public GetGratitudeListModelInner setReminderAt2Int(Integer reminderAt2Int) {
    ...
    public GetGratitudeListModelInner setPictureDevicePath(String pictureDevicePath) {
