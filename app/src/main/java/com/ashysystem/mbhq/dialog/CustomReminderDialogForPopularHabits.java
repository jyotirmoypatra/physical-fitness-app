...
public class CustomReminderDialogForPopularHabits extends DialogFragment {
    ...
    String receiveModel="";
    GetHabitTemplatesResponseModel.TemplateDetail globalGratitudeModel;
    ...
    {
        Gson gson=new Gson();
        globalGratitudeModel=gson.fromJson(receiveModel, GetHabitTemplatesResponseModel.TemplateDetail.class);
        ...
        try {
            dataJsonReq.put("FrequencyId",globalGratitudeModel.getHabitFrequencyId());
            dataJsonReq.put("PushNotification",true);
            if(globalGratitudeModel.getHabitFrequencyId()!=null && globalGratitudeModel.getHabitFrequencyId()!=0)
            {
                if(globalGratitudeModel.getHabitFrequencyId() == 1)
                {
                    spReminderFrequency.setSelection(0);
                    txtReminderFrequencyType.setText(arrFreq[0]);
                }else if(globalGratitudeModel.getHabitFrequencyId() == 3)
                {
                    spReminderFrequency.setSelection(1);
                    txtReminderFrequencyType.setText(arrFreq[1]);
                }else if(globalGratitudeModel.getHabitFrequencyId() == 4)
                {
                    spReminderFrequency.setSelection(2);
                    txtReminderFrequencyType.setText(arrFreq[2]);
                }else if(globalGratitudeModel.getHabitFrequencyId() == 5)
                {
            ...
            if(globalGratitudeModel.getTaskMonthly()!=null && globalGratitudeModel.getTaskMonthly()!=0)
            {
                dataJsonReq.put("MonthReminder",globalGratitudeModel.getTaskMonthly());
                spMonth.setSelection(globalGratitudeModel.getTaskMonthly()-1);
                txtReminderDayFrequencyMonth.setText(lstReminderMonth.get(globalGratitudeModel.getTaskMonthly()-1));
            }
