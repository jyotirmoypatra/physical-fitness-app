...
/**
 * Created by android-krishnendu on 6/12/17.
 */

public class CustomReminderDialogAddGratitude extends DialogFragment {
    ...
    String text = "";
    //////////////////////
    private TextView txtReminderFrequencyType,txtCalender,txtReminderDayFrequencyMonth,txtAmPmUp,txtAmPmDownwn;
    private Spinner spReminderFrequency,spMonth,spAmPm,spBtwn,spAmPmDown;
    View vwLLReminder,vwDay,vwYear,vwWK,vwDown;
    private LinearLayout llWk,llBtwnDown1,llDay,llDaily,llYear,llAmPmUp,llAmPmDown,llBtwnDown,llReminderFrequencySpinner;
...
String habitname="";
    ...
    private void initView(Dialog dialog) {
        txtCalender=(TextView)dialog.findViewById(R.id.txtCalender);
