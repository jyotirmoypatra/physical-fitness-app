...
public class CustomReminderDialogForEditHabit extends DialogFragment {
    ...
    TextView txtTimePicker,txtTimePickerDown,txtCalender_;
...
String habitname="";
    ...
    private void populateJsonForGratitude(String receiveModel)
    {
        ...
        try {
            dataJsonReq.put("FrequencyId",globalGratitudeModel.getTaskFrequencyTypeId());
            dataJsonReq.put("PushNotification",true);
            if(globalGratitudeModel.getTaskFrequencyTypeId()!=null && globalGratitudeModel.getTaskFrequencyTypeId()!=0)
            {
                if(globalGratitudeModel.getTaskFrequencyTypeId() == 1)
                {
                    spReminderFrequency.setSelection(0);
                    txtReminderFrequencyType.setText(arrFreq[0]);
                }else if(globalGratitudeModel.getTaskFrequencyTypeId() == 3)
                {
                    spReminderFrequency.setSelection(1);
                    txtReminderFrequencyType.setText(arrFreq[1]);
                }else if(globalGratitudeModel.getTaskFrequencyTypeId() == 4)
                {
                    spReminderFrequency.setSelection(2);
                    txtReminderFrequencyType.setText(arrFreq[2]);
                }else if(globalGratitudeModel.getTaskFrequencyTypeId() == 5)
                {
                ...
                else if(globalGratitudeModel.getFrequencyId() == 5)
                {
            ...
            dataJsonReq.put("MonthReminder",globalGratitudeModel.getTaskMonthReminder());
            if(globalGratitudeModel.getTaskMonthReminder()!=null && globalGratitudeModel.getTaskMonthReminder()!=0)
            {
                spMonth.setSelection(globalGratitudeModel.getTaskMonthReminder()-1);
                txtReminderDayFrequencyMonth.setText(lstReminderMonth.get(globalGratitudeModel.getTaskMonthReminder()-1));
            }
            ...
            dataJsonReq.put("Sunday",globalGratitudeModel.getIsSundayTask());
            if(globalGratitudeModel.getIsSundayTask()!=null && globalGratitudeModel.getIsSundayTask())
            {
                boolS=true;
            ...
            dataJsonReq.put("Monday",globalGratitudeModel.getIsMondayTask());
            if(globalGratitudeModel.getIsMondayTask()!=null && globalGratitudeModel.getIsMondayTask())
            {
                boolM=true;
                buttonM.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("Tuesday",globalGratitudeModel.getIsTuesdayTask());
            if(globalGratitudeModel.getIsTuesdayTask()!=null && globalGratitudeModel.getIsTuesdayTask())
            {
                boolT=true;
                buttonT.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("Wednesday",globalGratitudeModel.getIsWednesdayTask());
            if(globalGratitudeModel.getIsWednesdayTask()!=null && globalGratitudeModel.getIsWednesdayTask())
            {
                boolW=true;
                buttonW.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("Thursday",globalGratitudeModel.getIsThursdayTask());
            if(globalGratitudeModel.getIsThursdayTask()!=null && globalGratitudeModel.getIsThursdayTask())
            {
                boolTH=true;
                buttonTH.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("Friday",globalGratitudeModel.getIsFridayTask());
            if(globalGratitudeModel.getIsFridayTask()!=null && globalGratitudeModel.getIsFridayTask())
            {
                boolF=true;
                buttonF.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("Saturday",globalGratitudeModel.getIsSaturdayTask());
            if(globalGratitudeModel.getIsSaturdayTask()!=null && globalGratitudeModel.getIsSaturdayTask())
            {
                boolSa=true;
                buttonSa.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("January",globalGratitudeModel.getIsJanuaryTask());
            if(globalGratitudeModel.getIsJanuaryTask()!=null && globalGratitudeModel.getIsJanuaryTask())
            {
                boolJan=true;
                buttonJan.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("February",globalGratitudeModel.getIsFebruaryTask());
            if(globalGratitudeModel.getIsFebruaryTask()!=null && globalGratitudeModel.getIsFebruaryTask())
            {
                boolFeb=true;
                buttonFeb.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("March",globalGratitudeModel.getIsMarchTask());
            if(globalGratitudeModel.getIsMarchTask()!=null && globalGratitudeModel.getIsMarchTask())
            {
                boolMar=true;
                buttonMar.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("April",globalGratitudeModel.getIsAprilTask());
            if(globalGratitudeModel.getIsAprilTask()!=null && globalGratitudeModel.getIsAprilTask())
            {
                boolApr=true;
                buttonApr.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("May",globalGratitudeModel.getIsMayTask());
            if(globalGratitudeModel.getIsMayTask()!=null && globalGratitudeModel.getIsMayTask())
            {
                boolMay=true;
                buttonMay.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("June",globalGratitudeModel.getIsJuneTask());
            if(globalGratitudeModel.getIsJuneTask()!=null && globalGratitudeModel.getIsJuneTask())
            {
                boolJun=true;
                buttonJun.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("July",globalGratitudeModel.getIsJulyTask());
            if(globalGratitudeModel.getIsJulyTask()!=null && globalGratitudeModel.getIsJulyTask())
            {
                boolJul=true;
                buttonJul.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("August",globalGratitudeModel.getIsAugustTask());
            if(globalGratitudeModel.getIsAugustTask()!=null && globalGratitudeModel.getIsAugustTask())
            {
                boolAug=true;
                buttonAug.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("September",globalGratitudeModel.getIsSeptemberTask());
            if(globalGratitudeModel.getIsSeptemberTask()!=null && globalGratitudeModel.getIsSeptemberTask())
            {
                boolSep=true;
                buttonSep.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("October",globalGratitudeModel.getIsOctoberTask());
            if(globalGratitudeModel.getIsOctoberTask()!=null && globalGratitudeModel.getIsOctoberTask())
            {
                boolOct=true;
                buttonOct.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("November",globalGratitudeModel.getIsNovemberTask());
            if(globalGratitudeModel.getIsNovemberTask()!=null && globalGratitudeModel.getIsNovemberTask())
            {
                boolNov=true;
                buttonNov.setBackgroundResource(R.drawable.circle_blue_month);
            }

            dataJsonReq.put("December",globalGratitudeModel.getIsDecemberTask());
            if(globalGratitudeModel.getIsDecemberTask()!=null && globalGratitudeModel.getIsDecemberTask())
            {
                boolDec=true;
...
if(null==habitname || "".equalsIgnoreCase(habitname)){
      /* Calendar beginTime = Calendar.getInstance();
                    beginTime.set(2023, 0, 1, 7, 0);
                    long startMillis = beginTime.getTimeInMillis();
                    Calendar endTime = Calendar.getInstance();
                    endTime.set(2023, 0, 1, 8, 0);
                    long endMillis = endTime.getTimeInMillis();
                    ContentValues values = new ContentValues();
                    values.put(CalendarContract.Events.DTSTART, startMillis);
                    values.put(CalendarContract.Events.DTEND, endMillis);
                    values.put(CalendarContract.Events.TITLE, "My Event");
                    values.put(CalendarContract.Events.DESCRIPTION, "A test event");
                    values.put(CalendarContract.Events.CALENDAR_ID, 1);
                    values.put(CalendarContract.Events.EVENT_TIMEZONE, "America/Los_Angeles");
                    Uri eventsUri = Uri.parse("content://com.android.calendar/events");
                    Uri eventUri = getActivity().getContentResolver().insert(eventsUri, values);
*/
...
//                    values.put(CalendarContract.Events.RRULE, "FREQ=WEEKLY;INTERVAL=2");
...
//                    intent.putExtra("rrule", "FREQ=DAILY;UNTIL=" + endCalendar.getTimeInMillis());
