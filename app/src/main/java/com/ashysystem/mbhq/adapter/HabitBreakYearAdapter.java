...
public class HabitBreakYearAdapter extends RecyclerView.Adapter<HabitBreakYearAdapter.MyViewHolder> {

    Context context;
    List<HabbitCalendarModel.BreakYearlyStat> lstHabitQuarter;
    HabbitDetailsCalendarFragment calendarFragment;

    public HabitBreakYearAdapter(Context context, List<HabbitCalendarModel.BreakYearlyStat> lstHabitQuarter, HabbitDetailsCalendarFragment calendarFragment)
    {
