...
public class HabitQuarterBreakAdapter extends RecyclerView.Adapter<HabitQuarterBreakAdapter.MyViewHolder> {

    Context context;
    List<HabbitCalendarModel.BreakQuarterlyStat> lstHabitQuarter;
    HabbitDetailsCalendarFragment calendarFragment;

    public HabitQuarterBreakAdapter(Context context, List<HabbitCalendarModel.BreakQuarterlyStat> lstHabitQuarter, HabbitDetailsCalendarFragment calendarFragment)
    {
