...
public class LiveChatPlayerFragment extends Fragment implements View.OnClickListener, View.OnTouchListener {
    ...
    public LiveChatPlayerFragment() {
        // Required empty public constructor
    }

    public static LiveChatPlayerFragment newInstance(Chat liveChatData) {
...
//                            imgPlayPauseOnVideo.setBackgroundResource(R.drawable.mbhq_play);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            liveChatData = (Chat) savedInstanceState.getSerializable("LIVE_CHAT_DATA");
        }
...
//                            imgPlayPause.setBackgroundResource(R.drawable.mbhq_pause); //
            ...
            if (musicSrv.getVideoName().equals(liveChatData.getEventName()) && musicSrv.getFromPage().equals(BackgroundSoundServiceNew.FromPage.LIVE_CHAT)) {
                ...
                musicSrv.createMediaPlayer(liveChatData.getEventName(), BackgroundSoundServiceNew.FromPage.LIVE_CHAT, liveChatData.getEventItemVideoDetails().get(0).getDownloadURL(), globalLinkMediaType, 0, liveChatData, stateListener);
