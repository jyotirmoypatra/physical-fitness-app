...
public class CustomReminderDialogForEditBucket extends DialogFragment {
    ...
    private LinearLayout llReminderFrequency,llWk,llDay,llDaily,llYear,llAmPmUp,llAmPmDown,llBtwnDown,llReminderFrequencySpinner,llBtwnUp;
    ...
    String receiveModel="";
    BucketListModelInner globalGratitudeModel;
    ...
    private void initJson() {
        try {
            dataJsonReq.put("FrequencyId",0);
            dataJsonReq.put("MonthReminder",0);
            dataJsonReq.put("ReminderOption",0);
    ...
    {
        Gson gson=new Gson();
        globalGratitudeModel=gson.fromJson(receiveModel,BucketListModelInner.class);
        try {
           ...
           /* if(globalGratitudeModel.getReminderAt2()!=null && Integer.parseInt(globalGratitudeModel.getReminderAt2())!=0)
            {
    ...
    private void initView(Dialog dialog) {
        ...
        llReminderFrequency=(LinearLayout)dialog.findViewById(R.id.llReminderFrequency);
        llReminderFrequency.setVisibility(View.GONE);
        ...
        llAmPmUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                spAmPm.setVisibility(View.GONE);
        ...
        llAmPmDown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                spAmPmDown.setVisibility(View.GONE);
        ...
        chkEmailNotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        chkPushNotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(chkPushNotification.isChecked())
                {
                    try {
                        dataJsonReq.put("PushNotification",true);
                    } catch (JSONException e) {
